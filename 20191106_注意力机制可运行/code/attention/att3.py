...
data_train = pd.read_csv('data/labeledTrainData.tsv', sep='\t',encoding="UTF-8") # encoding = "gbk"  encoding='gb2312' encoding='utf-8' ascii
...
#https://blog.csdn.net/uhauha2929/article/details/80733255
#自定义了一个Keras层
#不同的是，这里在softmax之前还加了tanh激活函数，而且将输出进行了求和，所以输出是二维的。
