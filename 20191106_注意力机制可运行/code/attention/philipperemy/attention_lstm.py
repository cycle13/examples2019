...
def attention_3d_block(inputs):
    ...
    output_attention_mul = multiply([inputs, a_probs], name='attention_mul') # elesun
...
if __name__ == '__main__':
    ...
    m.fit([inputs_1], outputs, epochs=10000, batch_size=64, validation_split=0.1,verbose=2) # elesun epochs=100
