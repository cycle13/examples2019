...
#K.set_image_data_format('channels_first') #elesun add
...
#                 input_shape=elesun x_train.shape[1:],#elesun x_train.shape[1:] (3,32,32)
#                 arguments={'rotation': 8.0, 'horizontal_flip': True}))
#model.add(Conv2D(32, (3, 3), padding='same'))#elesun del
model.add(Conv2D(32, (3, 3), padding='same', #elesun add
                 input_shape=x_train.shape[1:])) #elesun add
